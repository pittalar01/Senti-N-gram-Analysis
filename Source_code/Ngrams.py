...
folder = r'C:\Users\VaniSuresh\Desktop\imdb-movie-reviews-dataset\aclImdb'
labels = {'pos': 1, 'neg': 0}
df = pd.DataFrame()
for f in ('test', 'train'):    
    for l in ('pos', 'neg'):
...
df.to_csv(r'C:\Users\VaniSuresh\Desktop\movie_reviews\movie_data.csv',index=False , encoding= 'utf-8')
